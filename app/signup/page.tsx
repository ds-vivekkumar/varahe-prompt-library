      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-4">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-400 text-lg">Create your account with your Varahe Analytics email</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-blue-200 font-medium mb-1">Organization Access Only</h3>
                  <p className="text-blue-300 text-sm">
                    Account creation is restricted to <strong>@varaheanalytics.com</strong> email addresses only.
                  </p>
                </div>
              </div>
            </div>
